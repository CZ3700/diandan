...
> 下一可领取任务：`P1-04`（Lane A）或 `P2-01`（Lane B）；单个 executor 一次只领取一个
...
只领取位于 `ACTIVE` Phase、依赖已完成、状态为 `READY` 且对应 Lane 无 executor 的一个任务；当前 Lane A/B/C/D 均空闲，`P1-04` 与 `P2-01` 为 `READY`。
