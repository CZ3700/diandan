...
> 当前任务：`P2-02`（REVIEW，Codex `/root`，Lane B）
> 下一可领取任务：无；`P2-03` 与 `P2-04` 等待 P2-02 完成验收
...
只领取位于 `ACTIVE` Phase、依赖已完成、状态为 `READY` 且对应 Lane 无 executor 的一个任务；当前 P2-02 处于 `REVIEW` 并继续由 Codex `/root` 独占 Lane B，没有其他可领取任务。
